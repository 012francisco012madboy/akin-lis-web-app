...
//   // Remover useQuery e useMutation, usar apenas fetch
//   const handleEnviar = async () => {
//     if (!input.trim() || isPending) return;
//     setIsPending(true);
//     try {
//       const response = await fetch("https://34.118.135.69:5000/recepsionista", {
//         method: "POST",
//         headers: {
...
//         }),
//       });
//       if (!response.ok) throw new Error("Erro ao conectar com o agente.");
