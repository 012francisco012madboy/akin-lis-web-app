  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-akin-turquoise text-sidebar-foreground",
            className
          )}
          ref={ref}
          {...props}
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
           `duration-200 relative h-svh w-[${widthSideBar}] bg-transparent transition-[width] ease-linear`,
