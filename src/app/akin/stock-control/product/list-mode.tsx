    ...
    <div className="overflow-x-auto rounded-lg border border-gray-200 bg-white shadow-sm">
      ...
      <table className="min-w-full divide-y divide-gray-200 text-sm">
        ...
        <thead className="bg-gray-50">
          <tr>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wide">Nome do producto</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wide">Categoria</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wide">Data de Cadastro</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wide">Gramas</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wide">Quantidades</th>
        ...
        <tbody className="divide-y divide-gray-100">
          ...
          >
            <td className="px-4 py-3 text-gray-700">Paracetamol</td>
            <td className="px-4 py-3 text-gray-700"> Farmaco</td>
