...
// import { CustomerService } from "./patients-data";
...
//         <Input.InputFieldIcon icon={Search} placeholder="Pesquisar Paciente" fit type="search" value={value || ""} onChange={(e) => onGlobalFilterChange(e)} />
//       </div>
//     );
//   };
